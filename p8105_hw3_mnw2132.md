...
##  Class :character   1st Qu.:1988-11-29   1st Qu.:   0.00   1st Qu.:    0   
##  Mode  :character   Median :1997-01-21   Median :   0.00   Median :    0   
##                     Mean   :1997-01-01   Mean   :   2.98   Mean   :    5   
##                     3rd Qu.:2005-09-01   3rd Qu.:   2.30   3rd Qu.:    0   
##                     Max.   :2010-12-31   Max.   :2286.00   Max.   :10160   
##                                          NA's   :145838    NA's   :381221  
##       snwd             tmax              tmin             month       
##  Min.   :   0.0   Min.   :-38.9     Min.   :-59.4     Min.   : 1.000  
##  1st Qu.:   0.0   1st Qu.:  5.0     1st Qu.: -3.9     1st Qu.: 4.000  
##  Median :   0.0   Median : 15.0     Median :  3.3     Median : 7.000  
##  Mean   :  37.3   Mean   : 14.0     Mean   :  3.0     Mean   : 6.565  
##  3rd Qu.:   0.0   3rd Qu.: 23.3     3rd Qu.: 11.1     3rd Qu.:10.000  
##  Max.   :9195.0   Max.   : 60.0     Max.   : 60.0     Max.   :12.000  
##  NA's   :591786   NA's   :1134358   NA's   :1134420                   
##       year           day       
##  Min.   :1981   Min.   : 1.00  
##  1st Qu.:1988   1st Qu.: 8.00  
##  Median :1997   Median :16.00  
...
### Create a 2 panel plot for January and July

``` r
avg_temp <- cleaned_noaa %>%
...
![](p8105_hw3_mnw2132_files/figure-gfm/unnamed-chunk-5-1.png)<!-- -->
According to the highest average max temperatures in January in 1990 and
around 2006, and lowest temps in 1994 and 2004. Meanwhile the higherght
temps in July were in the years of 1999 and 2010, and the lowest
temperatures were 1992 and 2000.

### Tmax vs tmins

``` r
  ggplot(na.omit(cleaned_noaa) %>%
    filter(!is.na(tmax) & !is.na(tmin)),
    aes(x = tmax, y = tmin, color= id)) +
  geom_hex(alpha = 0.5, show.legend = FALSE) +
  labs(title = "Max Temp vs Min Temp") +
  viridis::scale_color_viridis(discrete = TRUE) + 
  theme_minimal()
```

![](p8105_hw3_mnw2132_files/figure-gfm/unnamed-chunk-6-1.png)<!-- -->

``` r
  ggplot(data= cleaned_noaa %>%
  filter(snow > 0 & snow < 100),
  aes(x = factor(year), y = snow, fill = id)) +
...
![](p8105_hw3_mnw2132_files/figure-gfm/unnamed-chunk-11-1.png)<!-- -->
...
![](p8105_hw3_mnw2132_files/figure-gfm/unnamed-chunk-13-1.png)<!-- -->
...
![](p8105_hw3_mnw2132_files/figure-gfm/unnamed-chunk-14-1.png)<!-- -->
...
![](p8105_hw3_mnw2132_files/figure-gfm/unnamed-chunk-20-1.png)<!-- -->
...
![](p8105_hw3_mnw2132_files/figure-gfm/unnamed-chunk-21-1.png)<!-- -->
